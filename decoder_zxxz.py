...
if __name__ == '__main__':
  ...
  train_fname ="zxxz3_train.db"
  validation_fname ="zxxz3_validation.db"
  test_fname ="zxxz3_test.db"
  ...
  checkpoint_path ="/home/jupyter-azahoundo/ZXXZ_code/checkpoint/"
  ...
  # # # feedback
  res = dec._calc_feedback(self, batch_sz=64, bootstrap=False, verbose=False)
